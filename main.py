...
@genai_app.get("/gemini-analyst-bq")
async def generate_output_bq(user_query: str,
                             client_id: str,
                             dataset_name: str = Query("competitividad", enum=["competitividad", "dummy"]),
...
@app.function(image=image,
              ...
              mounts=[Mount.from_local_file("key.json",
                      ...
                      Mount.from_local_file("key2.json",
                      remote_path="/root/key2.json"),
